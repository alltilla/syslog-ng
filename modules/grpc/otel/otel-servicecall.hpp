...
class OtelAsyncServiceCall;


using OtelTraceServiceCall = OtelAsyncServiceCall<TraceService::AsyncService,
      ExportTraceServiceRequest, ExportTraceServiceResponse>;
using OtelLogsServiceCall = OtelAsyncServiceCall<LogsService::AsyncService,
      ExportLogsServiceRequest, ExportLogsServiceResponse>;
using OtelMetricsServiceCall = OtelAsyncServiceCall<MetricsService::AsyncService,
