...
private:
  void create_grpc_request_counter(StatsClusterKeyBuilder *kb, int stats_level,
                                   const ::grpc::StatusCode &response_code, const std::string &response_code_label);
  void create_grpc_request_counters(StatsClusterKeyBuilder *kb, int stats_level);
