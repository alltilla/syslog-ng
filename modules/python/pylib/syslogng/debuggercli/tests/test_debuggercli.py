...
class TestDebuggerCLI(CompleterTestCase):
    ...
    def test_literal_text_plus_dollar_offers_macros_using_the_literal_as_prefix(
            self):
        self._assert_completions_offered(
            entire_input="print foobar$",
            word="foobar$",
    ...
    def test_literal_text_plus_dollar_paren_offers_template_functions_using_the_literal_as_prefix(
            self):
        self._assert_completions_offered(
            entire_input="print foobar$(",
            word="foobar$(",
    ...
    def test_literal_text_plus_dollar_brace_offers_macros_using_the_literal_as_prefix(
            self):
        self._assert_completions_offered(
            entire_input="print foobar${",
            word="foobar${",
    ...
    def test_template_function_offers_potential_opts(self):
        self._assert_completions_offered(
            entire_input="print 'foobar$(format-json ",
            word="",
            expected_completions=['--pair '])
        self._assert_completions_offered(
            entire_input="print 'foobar$(echo ",
            word="",
            expected_completions=['$', '$(', '${'])

    def test_complex_cases(self):
        self._assert_completions_offered(
            entire_input="print 'foo$(format-json --key *)bar",
            word="",
            expected_completions=['$(', '${', '$'])
        self._assert_completions_offered(
            entire_input="print 'foo$(format-json --key *)bar$(echo ",
            word="",
            expected_completions=['$(', '${', '$'])
        self._assert_completions_offered(
            entire_input="print 'foo$(format-json --key *)${MSG}$(echo ",
            word="",
            expected_completions=['$(', '${', '$'])
        self._assert_completions_offered(
            entire_input=
            "print 'foo$(format-json --key *)${MSG}$(echo $MSGHDR)",
            word="",
            expected_completions=['$(', '${', '$'])
